...
I will choose the "vancouver_trees" dataset. The reason is that this dataset provides a comprehensive insight into different trees in Vancouver. It will help me study the nature and learn more about Vancouver.
...
What age range do most of Vancouver's trees fall into, and how is their age distribution related to the geographical areas?
...
I chose to plot the distribution of tree diameters because from this plot we can infer about the most common diameters in Vancouver.
...
I created a new variable called "age" based on an existing variable "date_planted". Because age can help us understand a tree's stage more intuitively.
...
The following plot shows the median and the age range of trees in different neighbourhood. It aligns to my first research topic in task 1.4.
...
The boxplot for age can give us insights into the diversity of tree ages in Vancouver.
